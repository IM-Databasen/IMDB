        ...
        <div class="flex flex-wrap flex-row -mx-4 text-center">
          <div class="flex-shrink px-4 max-w-full w-full sm:w-1/2 lg:w-1/3 lg:px-6 wow fadeInUp" data-wow-duration="1s"
            ...
            <div
              ...
              <h3 class="text-lg leading-normal mb-2 font-semibold text-black">Prøver</h3>
              <p class="text-gray-500">Få svar te vanskelige prøver som nettverksprøven</p>
            </div>
          </div>
          <div class="flex-shrink px-4 max-w-full w-full sm:w-1/2 lg:w-1/3 lg:px-6 wow fadeInUp" data-wow-duration="1s"
            data-wow-delay=".1s"
            ...
            <div
              ...
              <h3 class="text-lg leading-normal mb-2 font-semibold text-black">Memes</h3>
              <p class="text-gray-500">Få tilgang te eksklusive IM memes</p>
            </div>
          </div>
          <div class="flex-shrink px-4 max-w-full w-full sm:w-1/2 lg:w-1/3 lg:px-6 wow fadeInUp" data-wow-duration="1s"
            data-wow-delay=".3s"
            ...
            <div
              ...
              <h3 class="text-lg leading-normal mb-2 font-semibold text-black">Test</h3>
              <p class="text-gray-500">Test card</p>
            </div>
            <!-- end service block -->
          </div>
        </div>
